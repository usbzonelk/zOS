;zOS - A modified Operating System of MikeOS
;===================================================================

	BITS 16
	%DEFINE zOS_VER '1.0.0'	 ;OS version number
	%DEFINE zOS_API_VER 1	; API version for programs to check
	%DEFINE KEY_ESC		27
...
option_screen:
	...
	os_init_msg		db 'This is zOS', 0
	os_version_msg		db 'Version ', zOS_VER, 0

	os_init_msg2		db '                 Computer Hardware Information                               ', 0
	os_version_msg2		db 'Version ', zOS_VER, 0

	dialog_string_1		db 'This is a modified version of MikeOS', 0
	dialog_string_2		db 'To check basic computer hardaware info', 0
	dialog_string_3		db 'choose Enter in the menu', 0
...
os_draw_background1:
	...
	mov cx, 01111111b		; Colour: black text on light grey
...
hardware_info:
	...
	msgUnknownCmd		db	"Unknown command or unexecutable file!", 0x00
	
	strmemory		db	"Base Memory size: ", 0x00
	strsmallextended	db	"Extended memory size [between(1M - 16M)]: ", 0x00
	strbigextended		db      "Extended memory size [above 16M]: ", 0x00
	strCPUVendor		db	"CPU Vendor : ", 0x00
	strCPUdescription	db	"CPU info: ", 0x00
	strNotSupported		db	"Not supported.", 0x00
	strhdnumber		db	"Number of HDDs: ",0x00
	strserialportnumber	db	"Number of Serial ports: ", 0x00
	strserialport1		db	"Base I/O address of Serial Port 1 (COM 1): ", 0x00
